    ...
    try {
      ...
      const formattedHistory = rows.map((row) => {
        return {
          ...
          travelDate: formatDate(row.date),
          fromLocation: row.from_location,
          toLocation: row.to_location,
          vehicleType: row.in_vehicle_type,
          inMeterNumber: row.in_vehicle_mtr_number,
          outMeterNumber: row.out_vehicle_mtr_number,
          totalMeterNumber: row.total_running_km,
          vehicleImages: row.in_vehicle_mtr_pic_ticket_pic,
          outImage: row.vehical_mtr_pic,
          remarks: row.in_remarks || row.out_remarks,
