...
//       ? u.sales_person_name
//           ?.toLowerCase()
//           .includes(salesPersonFilter.toLowerCase())
//       : true;
...
//                   {[
//                     ...new Set(
//                       users.map((u) => u.sales_person_name).filter(Boolean),
//                     ),
//                   ].map((name, idx) => (
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      access:
        pageAccess.length === pageOptions.length ? "ALL" : pageAccess.join(","),
      in_office: formData.in_office,
      employee_id: formData.employee_id, // ADDED
    };
        ...
        <div className="overflow-x-auto max-h-[400px]">
          <table className="w-full text-sm">
              ...
              <tr className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
                ...
                <th className="px-4 py-3 text-center font-medium">Employee ID</th>
                <th className="px-4 py-3 text-center font-medium">User Name</th>
                <th className="px-4 py-3 text-center font-medium">Password</th>
                <th className="px-4 py-3 text-center font-medium">Admin</th>
                <th className="px-4 py-3 text-center font-medium">Access</th>
          ...
          <div className="space-y-4">
            {filteredUsers.map((u) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <div>
                    <p className="text-xs text-gray-500 mb-1">Employee ID</p> {/* ADDED */}
                    {editUserId === u.id ? (
                      <input
                        name="employee_id"
                        value={editData.employee_id || ""}
                      ...
                      <p className="text-sm font-medium">{u.employee_id || "-"}</p>
                    )}
                  </div>
